...
# VK Mini Apps: create-vk-mini-app

## How to install

### Create VK Mini App with gh-pages deploy

`create-vk-mini-app <app-directory-name>`
...
`create-vk-mini-app <app-directory-name> --promise`
